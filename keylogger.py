...
class keylogger_main:
    ...
    def _build_logs(self):             #To create the directory which contains all the screenshots and log files 
        if not os.path.exists('/Users/harikalagara/Desktop/Honeypot-Implementation-master/Keylogger'):
            os.mkdir('/Users/harikalagara/Desktop/Honeypot-Implementation-master/keylogger')
            os.mkdir('/Users/harikalagara/Desktop/Honeypot-Implementation-master/keylogger')
            os.mknod('/Users/harikalagara/Desktop/Honeypot-Implementation-master/Keylogger/log.txt')
    ...
    def _Screenshot(self):           #Main Function to start thr Screenshot tracker
        sct=mss()
        sct.shot(output='/Users/harikalagara/Desktop/Honeypot-Implementation-master//Keylogger/Screenshots/{}.png'.format(time.time()))
